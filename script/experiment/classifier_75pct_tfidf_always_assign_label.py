...
from script.helper.balancer_always_assign_label import *
import time
import operator
...
if __name__ == '__main__':
    ...
    log_filename = '../../log/classifier_75pct_tfidf_always_assign_label.log'
    ...
    try:
        ...
        classifier = OneVsRestClassifierBalanceAlwaysAssignLabel(clf)
