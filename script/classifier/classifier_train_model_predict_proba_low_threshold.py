...
from script.helper.balancer_low_threshold import OneVsRestClassifierBalanceLowThreshold
...
if __name__ == '__main__':
    ...
    model_filename = '../../model/model_proba_low_threshold.clf' 
    log_filename = '../../log/classifier_train_model_predict_proba_low_threshold.log'
    ...
    try:
        ...
        classifier = OneVsRestClassifierBalanceLowThreshold(clf)
