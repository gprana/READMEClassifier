...
if __name__ == '__main__':
    ...
    input_filename = config['DEFAULT']['section_overview_75pct_filename']
    log_filename = '../../log/load_section_overview_75pct.log'
    ...
    try:
        ...
        conn.commit()
        df.to_sql('section_overview_75pct', conn, if_exists='append', index=False)
        ...
        c.execute('DELETE FROM section_overview_75pct WHERE heading_markdown=\'##\'')
        conn.commit()
