...
def extract_section_from_abstracted_files(temp_abstracted_markdown_file_dir):
    ...
    try:
        ...
        df_to_save.to_sql(name='section_content_75pct', con=conn, if_exists='append', index=False)
    except Error as e:
        logging.exception(e)
...
if __name__ == '__main__':
    ...
    log_filename = '../../log/load_section_content_75pct.log'
#     temp_abstracted_html_file_dir = config['DEFAULT']['temp_abstracted_html_file_dir']
    ...
    try:
        ...
        result = c.execute('DELETE FROM section_content_75pct')
